/*
 * platform/lpc/memory_bus_dma_finalizer.h
 * Copyright (C) 2014 xent
 * Project is distributed under the terms of the MIT License
 */

#ifndef DPM_PLATFORM_LPC_MEMORY_BUS_DMA_FINALIZER_H_
#define DPM_PLATFORM_LPC_MEMORY_BUS_DMA_FINALIZER_H_
/*----------------------------------------------------------------------------*/
...
END_DECLS
/*----------------------------------------------------------------------------*/
#endif /* DPM_PLATFORM_LPC_MEMORY_BUS_DMA_FINALIZER_H_ */
