/*
 * dpm/platform/lpc/one_wire_uart.h
 * Copyright (C) 2013 xent
 * Project is distributed under the terms of the MIT License
 */

#ifndef DPM_PLATFORM_LPC_ONE_WIRE_UART_H_
#define DPM_PLATFORM_LPC_ONE_WIRE_UART_H_
/*----------------------------------------------------------------------------*/
#include <dpm/one_wire.h>
...
/*----------------------------------------------------------------------------*/
#endif /* DPM_PLATFORM_LPC_ONE_WIRE_UART_H_ */
